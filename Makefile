...
SRCS = src/clerr.c src/imgsrc_x11.c src/main.c src/pixconv.c src/rect.c src/ringbuf.c src/stats.c src/venc.c
HDRS = src/assets.h src/clerr.h src/imgsrc.h src/pixconv.h src/rect.h src/ringbuf.h src/stats.h src/util.h src/venc.h
